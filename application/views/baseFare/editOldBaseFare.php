...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <small>Tambah / Edit Tarif Dasar</small>
      </h1>
    </section>
              ...
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title"> Masukkan Rincian Tarif</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    ...
                    <form role="form" id="addNewBaseFare" action="<?php echo base_url() ?>updateOldBaseFare" method="post" role="form">
                        <div class="box-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="baseFareHour">Tarif Perjam</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="baseFareDay">Tarif Perhari</label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="serviceCharge">Biaya Layanan</label>
