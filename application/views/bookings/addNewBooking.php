              ...
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Masukkan Detail Pemesanan</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    ...
                    <form role="form" id="" action="<?php echo base_url() ?>addedNewBooking" method="post" role="form">
                        <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="customerId">Customer (Klik pada <i class="fa fa-search"></i> untuk mencari)</label>
                                        <div class="input-group">
