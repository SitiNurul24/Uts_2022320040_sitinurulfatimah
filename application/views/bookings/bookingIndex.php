...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-book" aria-hidden="true"></i> Pemesanan
        <small>Tambah, Edit, Hapus</small>
        <span class='pull-right'>
        <a class="btn btn-primary btn-lg hidden-xs" href="<?= base_url(); ?>addNewBooking"><i class="fa fa-plus" aria-hidden="true"></i> Tambah Pemesanan Baru</a>
        </span>
      </h1>
    </section>
    <br>
                ...
                <div class="box-body table-responsive no-padding">
                  <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <a href="<?= base_url('booking/generatePDF') ?>" class="btn btn-sm btn-warning" title="Report"><i class="fa fa-info-circle"></i></a>
