<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
      <i class="fa fa-book" aria-hidden="true"></i> Manajemen Pemesanan
        <small>Buat / Edit Pemesanan</small>
      </h1>
    </section>
              ...
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Masukkan Detail Pemesanan : <b><?= $bookingDetails->customerName ?></b> (<?= date('Y-m-d', strtotime($bookingDetails->bookStartDate)) ?> to <?= date('Y-m-d', strtotime($bookingDetails->bookEndDate)) ?>)</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    ...
                    <form role="form" id="editOldBooking" action="<?php echo base_url() ?>booking/updateOldBooking" method="post" role="form">
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="endDate">Ke Tanggal</label>
                                        <div class="input-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="sizeId">Ukuran Ruangan</label>
                            ...
                            <div class="row">
							    <div class="col-md-12 text-right">                                
                                    <button type="button" class="btn btn-primary btn-md" id='checkAvailableBtn'>Periksa Ketersediaan</button>
                            ...
                            <div class="row">
							    <div class="col-md-6">                                
                                    <div class="form-group">
                                        <label for="roomId">Nomor Ruangan</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="customerId">Pelanggan (Klik pada <i class="fa fa-search"></i> untuk mencari)</label>
                                        <div class="input-group">
