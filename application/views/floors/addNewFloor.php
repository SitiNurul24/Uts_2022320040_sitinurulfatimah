<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
      Manajemen Lantai
        <small>Tambah / Edit Lantai</small>
      </h1>
    </section>
              ...
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Masukkan Detail Lantai</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    ...
                    <form role="form" id="addNewFloors" action="<?php echo base_url() ?>addedNewFloor" method="post" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="floorCode">Kode Lantai</label>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="floorDescription">Deskripsi Lantai</label>
