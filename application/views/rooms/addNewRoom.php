<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Manajemen Ruangan
        <small>Pilih / Edit Ukuran Ruangan</small>
      </h1>
    </section>
              ...
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Masuk ke Detail Kamar</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    ...
                    <form role="form" id="addUser" action="<?php echo base_url() ?>addedNewRoom" method="post" role="form">
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="email">Ukuran Ruangan</label>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="mobile">Nomor Ruangan</label>
